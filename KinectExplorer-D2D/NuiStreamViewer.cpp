    ...
    , m_fps(0)
{
	...
	//avi = CreateAvi(L"aviout.avi", 33, nullptr);
}
...
//EIGENCODE
//void imageBufferToAVI(const HAVI avi, const NuiImageBuffer* pImage) {
//	
//	BYTE * bytes = pImage->GetBuffer();
